...
<head>
  ...
  <title>Bulk Orders Admin Panel</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a href="/" style="margin-right: 20px; font-size: 1.5em; color: white;"><i class="fa fa-angle-double-left"></i></a><a class="navbar-brand" href="index.html">Bulk Orders Admin Panel</a>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © Cartoonize 2018</small>
        </div>
      </div>
    </footer>
